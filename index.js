...
function validateName() {
    ...
    if (name.length == 0) {
        nameError.innerHTML = '*Obrigatório';
        return false;
    }
...
function validateEmail() {
    ...
    if (email.length == 0) {
        emailError.innerHTML = '*Obrigatório'
        return false;
...
function validateMessage() {
    ...
    if (left > 0) {
        messageError.innerHTML = left + ' caracteres necessários'
        return false;
    }
...
function validateForm() {
    if (!validateName() || !validateEmail() || !validateMessage()) {
        ...
        submitError.innerHTML = '<i class="fa-sharp fa-solid fa-triangle-exclamation"> Erro preencha todos os campos</i>';
